...
@section('content')
    ...
    <section class="hero-section" style="position: relative; overflow: hidden; z-index: 1;">
        ...
        <div id="hero-light-bg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1; background-image: url('https://images.unsplash.com/photo-1497366811353-6870744d04b2?q=80&w=2000&auto=format&fit=crop'); background-size: cover; background-position: center; opacity: 0; transition: opacity 0.8s ease; pointer-events: none;">
            <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(to right, rgba(248, 250, 252, 0.85) 30%, rgba(248, 250, 252, 0.4) 100%);"></div>
        </div>
    ...
    <section class="section testimonials-section" style="background: rgba(255, 255, 255, 0.01); border-top: 1px solid var(--border-color); border-bottom: 1px solid var(--border-color); overflow: hidden; padding: 60px 0;">
        <div class="container">
            <div class="section-header" style="margin-bottom: 40px;">
                <span class="section-badge" style="background: rgba(0, 242, 254, 0.1); border-color: rgba(0, 242, 254, 0.2); color: var(--accent);">TESTIMONI KLIEN</span>
                ...
                <div class="features-grid">
                    ...
                    <div class="glass-card" style="padding: 0; overflow: hidden; display: flex; flex-direction: column;">
                        <div style="width: 100%; height: 160px; overflow: hidden; border-bottom: 1px solid var(--border-color);">
                            <img src="/images/feature_3d_webgl.png" alt="Immersive 3D Visuals" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.5s ease;">
                        </div>
                        <div style="padding: 24px;">
                            ...
                            <h3 class="feature-title" style="margin-top: 10px;">Immersive 3D Visuals</h3>
                    ...
                    <div class="glass-card" style="padding: 0; overflow: hidden; display: flex; flex-direction: column;">
                        <div style="width: 100%; height: 160px; overflow: hidden; border-bottom: 1px solid var(--border-color);">
                            <img src="/images/feature_speed.png" alt="Ultra Performance" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.5s ease;">
                        </div>
                        <div style="padding: 24px;">
                            ...
                            <h3 class="feature-title" style="margin-top: 10px;">Ultra Performance</h3>
                            <p class="feature-desc">
                    ...
                    <div class="glass-card" style="padding: 0; overflow: hidden; display: flex; flex-direction: column;">
                        <div style="width: 100%; height: 160px; overflow: hidden; border-bottom: 1px solid var(--border-color);">
                            <img src="/images/feature_secure.png" alt="Secure & Laravel Core" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.5s ease;">
                        </div>
                        <div style="padding: 24px;">
                            ...
                            <h3 class="feature-title" style="margin-top: 10px;">Secure & Laravel Core</h3>
                            <p class="feature-desc">

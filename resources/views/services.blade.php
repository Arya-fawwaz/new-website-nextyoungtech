                    ...
                    @foreach($services as $service)
                        @php
                            $color = in_array($service->warna_aksen, ['primary', 'secondary', 'accent', 'success', 'warning']) 
                                ...
                                : $service->warna_aksen;
                        @endphp
                        <div class="glass-card" style="border-color: rgba(99, 102, 241, 0.15); display: flex; flex-direction: column; justify-content: space-between; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);">
                            <div>

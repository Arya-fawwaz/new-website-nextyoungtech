            ...
            <body>
                ...
                <table class="info-table">
                    ...
                    <tr>
                        ...
                        <td style="font-weight: bold; color: #0284c7;">Rp ' . number_format($quote->estimasi_harga, 0, ',', '.') . '</td>
                    </tr>
                </table>
        ...
        switch ($type) {
            case 'quotes':
                ...
                $callback = function() use($data, $totalVal, $count, $pendingCount, $reviewedCount, $approvedCount) {
                    ...
                    $html .= 'table.main-table th { background-color: #0284c7; color: #ffffff; font-weight: bold; text-align: left; padding: 12px 10px; font-size: 13px; border: 1px solid #cbd5e1; text-transform: uppercase; }';
                    ...
                    $html .= '<tr><td class="summary-label">Total Potensi Omset:</td><td class="summary-value" style="color: #0284c7;">Rp ' . number_format($totalVal, 0, ',', '.') . '</td></tr>';
                    ...
                    $html .= '<td style="text-align: right; font-weight: bold; color: #0284c7; border: 1px solid #cbd5e1; padding: 10px;">Rp ' . number_format($totalVal, 0, ',', '.') . '</td>';
